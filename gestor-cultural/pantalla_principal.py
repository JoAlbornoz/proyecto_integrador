...
class PantallaPrincipal(tk.Tk):
    ...
    def create_widgets(self):
        ...
        listas_boton = Button(frame, text='Listas', width=20, height=2, font=('Arial', 15), bg='orange', fg='white', cursor='hand2', command=self.abrir_listas)
        ...
        listas_boton.grid(row=1, column=1, padx=10, pady=10, sticky="e")
    ...
    def abrir_listas(self):
        try:
            os.system("python C:/Users/josef/proyectos/proyecto-integrador/gestor-cultural/client/listas.py")
            print("Script listas.py se está ejecutando")
